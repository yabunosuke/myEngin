...
void TitleManager::Update()
{
	...
	{
		select_num_ = 1;
		end_text_->transform_->scale = { 1.2f,1.2f,1.2f };
		start_text_->transform_->scale = { 1.0f,1.0f,1.0f };
	}
	else if (stick_y < 0)
	{
		select_num_ = 0;
		start_text_->transform_->scale = { 1.2f,1.2f,1.2f };
		end_text_->transform_->scale = { 1.0f,1.0f,1.0f };
	}
